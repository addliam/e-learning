    ...
    <main className="bg-lightGray min-h-screen">
      ...
      <section className="flex flex-row gap-5 items-center justify-center">
        ...
        <div>
          ...
          <p className="max-w-[880px] text-[14px]">
            El movil se desplaza sobre una trayectoria recta estando sometida a
            una aceleracion constante. Su velocidad varia constantemente, la
            velocidad aumenta o disminuye de forma permanente.
          </p>
        </div>
      </section>
      <section className="flex flex-row justify-center flex-wrap mx-28 py-[2em] gap-x-6 gap-y-8">
        {
