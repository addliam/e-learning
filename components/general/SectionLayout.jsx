    ...
    <main className="">
      ...
      <section className="mt-5 flex justify-center items-center">
        ...
        <div className="w-[45%] flex justify-center items-center h-[3rem]">
          <ProgressBar part={id ? id : 1} total={total ? total : 3} />
        </div>
      ...
      <section
        ref={refContent}
        className="content relative flex justify-center my-4 overflow-y-scroll max-h-[30rem]"
      >
        <div className="subsection_content w-[36.25rem] pt-6">{children}</div>
      </section>
    </main>
  );
};
